...
describe('getWADORSImageId', () => {
  ...
  describe('with no frame provided', () => {
    ...
    it('should work on a real wadorsuri', () => {
      const instance = {
        wadorsuri:
          'http://localhost:8899/dicom-web/studies/1.3.6.1.4.1.25403.52237031786.3872.20100510032220.1/series/1.3.6.1.4.1.25403.52237031786.3872.20100510032220.2/instances/1.3.6.1.4.1.25403.52237031786.3872.20100510032220.8/frames/22',
      };

      expect(getWADORSImageId(instance)).toEqual(
        'wadors:http://localhost:8899/dicom-web/studies/1.3.6.1.4.1.25403.52237031786.3872.20100510032220.1/series/1.3.6.1.4.1.25403.52237031786.3872.20100510032220.2/instances/1.3.6.1.4.1.25403.52237031786.3872.20100510032220.8/frames/1'
      );
    });
  });
  ...
  describe('with a frame provided', () => {
    ...
    it('should work on a real wadorsuri', () => {
      ...
      expect(getWADORSImageId(instance, frame)).toEqual(
        'wadors:http://localhost:8899/dicom-web/studies/1.3.6.1.4.1.25403.52237031786.3872.20100510032220.1/series/1.3.6.1.4.1.25403.52237031786.3872.20100510032220.2/instances/1.3.6.1.4.1.25403.52237031786.3872.20100510032220.8/frames/43'
      );
    });
  });
});
